      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-base font-light text-gray-400 md:mt-0 md:order-1">
            &copy; 2022 Screenshotify. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
                ...
                <ul role="list" className="mt-4 space-y-4">
                  {navigation2.solutions.map((item) => (
                    <li key={item.name}>
                      <a
                        href={item.href}
                        className="text-base text-gray-500 dark:text-zinc-400  hover:text-gray-900 dark:hover:text-zinc-200 transition-all duration-300"
                      >
                        {item.name}
                      </a>
                    </li>
